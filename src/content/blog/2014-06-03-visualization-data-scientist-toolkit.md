...
<ul>
	...
	<li><strong><a style="font-style:normal;" href="https://networkx.org">Networkx</a></strong> - a package for working and manipulating graph. Implements many graph algorithms such as shortest path, clustering, minimum spanning tree, etc. The graphs created in Networkx can be drawn using either matplotlib or pygraphviz and can also create dot files.</li>
</ul>
